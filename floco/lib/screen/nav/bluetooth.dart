...
void arduboardConnect() async {
  ...
  Navigator.push(context,
    MaterialPageRoute(
      builder: (context) => Arduboard(device: bleDevice)));}     
...
child: ListTile(title: Text('connect to arduboard'), trailing: Icon(Icons.chevron_right),
onTap: arduboardConnect))),
